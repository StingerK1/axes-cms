<?php
        ...
        Project - A(xes) CMS Application (artist_create.php) 
        Page for artists to create a post
    */
    ...
    if (isset($_GET['userId'])) {
        ...
        $query = "SELECT * FROM artistboard WHERE userId = :userId";
                ...
                <div class="panel panel-default">
                    <div class="col-md-12">
                        <form style="max-width:600px;margin:auto;" action="artistboard_process.php" method="post">
                            ...
                            <div class="col-md-12">
                                <label>Content</label>
                                <textarea name="artistPost" id="artistPost" class="form-control mb-3" rows="4" style="resize: none;"></textarea>
                            </div> 
                            <div class="col=md-12">
                                <br>
